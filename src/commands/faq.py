...
class FAQGroup(app_commands.Group):
    ...
    @app_commands.command(name="fng", description="Learn about FNG")
    async def fng(self, interaction: Interaction):
        fng_info = (
            ...
            "Moreover, on the final Friday of each month within semester, we have free food for all members! Type ``/fng food`` to find out when the next FNG with food will be.\n\n"
